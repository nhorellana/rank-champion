        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 text-center">
            <div className="bg-muted/50 rounded-lg p-2 border border-border/30">
              ...
              <div className="text-sm font-semibold text-primary">{project.eficienciaRecursos}</div>
            </div>
            <div className="bg-muted/50 rounded-lg p-2 border border-border/30">
              <div className="flex items-center justify-center gap-1 text-xs text-muted-foreground">
                <Lock className="h-2.5 w-2.5" />
              ...
              <div className="text-sm font-semibold text-primary">{project.desempenoEquipo}</div>
            </div>
          </div>
